...
in OSHAL a harassment-free experience for everyone, regardless of age,
...
requests, discussions, commit messages, code review, and all official
project channels — and also when an individual is officially
representing the project in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may
be reported to the project maintainers at `maintainer@emeraldcoastsystemsgroup.com`.
