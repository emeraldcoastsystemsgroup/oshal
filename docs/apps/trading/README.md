...
- [futures-research-loop.md](./futures-research-loop.md) — console-configured nightly study worker and interactive research review; remaining acceptance is explicit.
