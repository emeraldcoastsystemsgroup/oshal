...
| **Description** | Expensify — reads export report, get policy list, get policy via integrations.expensify.com. Bring your own key: each user pastes their own token, held per-user in the encrypted connection store. |
