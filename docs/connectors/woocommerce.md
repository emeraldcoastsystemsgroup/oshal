...
| **Description** | WooCommerce — reads products, orders, customers, product via yourstore.example.com. Bring your own key: each user pastes their own token, held per-user in the encrypted connection store. |
