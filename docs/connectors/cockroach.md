...
| **Description** | CockroachDB Cloud — reads clusters, cluster, backups via cockroachlabs.cloud. Bring your own key: each user pastes their own token, held per-user in the encrypted connection store. |
