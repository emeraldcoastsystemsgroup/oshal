...
| **Description** | Greenhouse — reads candidates, jobs, applications, users via harvest.greenhouse.io. Bring your own key: each user pastes their own token, held per-user in the encrypted connection store. |
