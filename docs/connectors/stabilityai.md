...
| **Auth** | OAuth2 (bearer) |
| **Description** | Stability AI — reads account, balance, engines via api.stability.ai. OAuth: the operator registers the provider app once, then each user connects their own account. |
