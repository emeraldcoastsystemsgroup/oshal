...
| **Description** | Pinecone — reads indexes, index, collections via api.pinecone.io. Bring your own key: each user pastes their own token, held per-user in the encrypted connection store. |
