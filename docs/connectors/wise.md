...
| **Auth** | OAuth2 (bearer) |
| **Description** | Wise — reads profiles, borderless accounts, transfers via api.transferwise.com. OAuth: the operator registers the provider app once, then each user connects their own account. |
| **Icon** | Wise (verified) |
