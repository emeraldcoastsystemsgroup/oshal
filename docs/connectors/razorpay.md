...
| **Description** | Razorpay — reads customers, payments, payment, orders and 2 more via api.razorpay.com. Bring your own key: each user pastes their own token, held per-user in the encrypted connection store. |
