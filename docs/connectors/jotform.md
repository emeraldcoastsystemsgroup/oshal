...
| **Description** | Jotform — reads list forms, get form, get form submissions via api.jotform.com. Bring your own key: each user pastes their own token, held per-user in the encrypted connection store. |
