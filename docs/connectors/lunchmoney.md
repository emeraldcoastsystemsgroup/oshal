...
| **Auth** | OAuth2 (bearer) |
| **Description** | Lunch Money — reads categories, transactions, assets via dev.lunchmoney.app. OAuth: the operator registers the provider app once, then each user connects their own account. |
