...
| **Auth** | OAuth2 (bearer) |
| **Description** | Daily — reads rooms, room, recordings via api.daily.co. OAuth: the operator registers the provider app once, then each user connects their own account. |
