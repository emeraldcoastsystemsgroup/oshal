...
| **Auth** | OAuth2 (bearer) |
| **Description** | Personio — reads employees, attendances via api.personio.de. OAuth: the operator registers the provider app once, then each user connects their own account. |
