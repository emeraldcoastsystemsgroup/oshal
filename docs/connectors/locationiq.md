...
| **Description** | LocationIQ — reads search, reverse, autocomplete via us1.locationiq.com. Bring your own key: each user pastes their own token, held per-user in the encrypted connection store. |
