...
| **Description** | Gorgias — reads tickets, ticket, ticket messages, customers and 1 more via yourdomain.gorgias.com. Bring your own key: each user pastes their own token, held per-user in the encrypted connection store. |
