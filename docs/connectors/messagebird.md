...
| **Description** | MessageBird — reads messages, balance, contacts via rest.messagebird.com. Bring your own key: each user pastes their own token, held per-user in the encrypted connection store. |
