...
| **Description** | NewsAPI — reads top headlines, everything, sources via newsapi.org. Bring your own key: each user pastes their own token, held per-user in the encrypted connection store. |
