...
| **Description** | Wordnik — reads definitions, random word via api.wordnik.com. Bring your own key: each user pastes their own token, held per-user in the encrypted connection store. |
