...
| **Auth** | OAuth2 (bearer) |
| **Description** | HelpCrunch — reads customers, chats, agents via api.helpcrunch.com. OAuth: the operator registers the provider app once, then each user connects their own account. |
