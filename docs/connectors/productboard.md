...
| **Auth** | OAuth2 (bearer) |
| **Description** | Productboard — reads features, products, notes via api.productboard.com. OAuth: the operator registers the provider app once, then each user connects their own account. |
