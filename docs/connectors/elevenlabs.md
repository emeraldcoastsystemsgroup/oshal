...
| **Description** | ElevenLabs — reads voices, models, user via api.elevenlabs.io. Bring your own key: each user pastes their own token, held per-user in the encrypted connection store. |
