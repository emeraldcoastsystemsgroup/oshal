...
| **Description** | SoundCloud — reads me, tracks, user via api.soundcloud.com. Bring your own key: each user pastes their own token, held per-user in the encrypted connection store. |
