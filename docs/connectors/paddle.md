...
| **Auth** | OAuth2 (bearer) |
| **Description** | Paddle — reads customers, customer, subscriptions, transactions and 2 more via api.paddle.com. OAuth: the operator registers the provider app once, then each user connects their own account. |
