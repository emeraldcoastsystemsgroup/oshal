...
| **Description** | WeatherAPI — reads current, forecast, search, astronomy via api.weatherapi.com. Bring your own key: each user pastes their own token, held per-user in the encrypted connection store. |
