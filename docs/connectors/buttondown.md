...
| **Description** | Buttondown — reads newsletters, subscribers, emails, get email via api.buttondown.com. Bring your own key: each user pastes their own token, held per-user in the encrypted connection store. |
