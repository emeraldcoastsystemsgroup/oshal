...
| **Auth** | OAuth2 (bearer) |
| **Description** | Vimeo — reads me, videos, video, albums and 2 more via api.vimeo.com. OAuth: the operator registers the provider app once, then each user connects their own account. |
| **Icon** | Vimeo (verified) |
