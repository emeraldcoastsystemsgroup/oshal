...
| **Description** | OpenDota — reads player, pro matches, heroes via api.opendota.com. Bring your own key: each user pastes their own token, held per-user in the encrypted connection store. |
