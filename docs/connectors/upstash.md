...
| **Description** | Upstash — reads redis databases, redis database, kafka clusters via api.upstash.com. Bring your own key: each user pastes their own token, held per-user in the encrypted connection store. |
