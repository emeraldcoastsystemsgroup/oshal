...
| **Auth** | OAuth2 (bearer) |
| **Description** | Printify — reads shops, shop products, shop orders via api.printify.com. OAuth: the operator registers the provider app once, then each user connects their own account. |
