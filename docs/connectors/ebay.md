...
| **Auth** | OAuth2 (bearer) |
| **Description** | eBay — reads item summary search, item via api.ebay.com. OAuth: the operator registers the provider app once, then each user connects their own account. |
| **Icon** | eBay (verified) |
