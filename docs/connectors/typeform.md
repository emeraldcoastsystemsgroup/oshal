...
| **Auth** | OAuth2 (bearer) |
| **Description** | Typeform — reads list forms, get form, list responses via api.typeform.com. OAuth: the operator registers the provider app once, then each user connects their own account. |
