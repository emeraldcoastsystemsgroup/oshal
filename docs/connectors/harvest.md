...
| **Auth** | OAuth2 (bearer) |
| **Description** | Harvest — reads time entries, projects, clients, me via api.harvestapp.com. OAuth: the operator registers the provider app once, then each user connects their own account. |
