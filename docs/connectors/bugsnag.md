...
| **Description** | Bugsnag — reads organizations, projects, errors, error and 2 more via api.bugsnag.com. Bring your own key: each user pastes their own token, held per-user in the encrypted connection store. |
