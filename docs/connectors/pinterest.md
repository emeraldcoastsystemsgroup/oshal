...
| **Auth** | OAuth2 (bearer) |
| **Description** | Pinterest — reads me, boards, pins, board pins via api.pinterest.com. OAuth: the operator registers the provider app once, then each user connects their own account. |
