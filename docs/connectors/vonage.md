...
| **Description** | Vonage — reads account numbers, search messages, search message via rest.nexmo.com. Bring your own key: each user pastes their own token, held per-user in the encrypted connection store. |
