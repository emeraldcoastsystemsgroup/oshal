...
| **Auth** | OAuth2 (bearer) |
| **Description** | WakaTime — reads me, summaries, stats, projects via api.wakatime.com. OAuth: the operator registers the provider app once, then each user connects their own account. |
