...
| **Auth** | OAuth2 (bearer) |
| **Description** | Docker Hub — reads user, repositories, repository, tags and 1 more via hub.docker.com. OAuth: the operator registers the provider app once, then each user connects their own account. |
