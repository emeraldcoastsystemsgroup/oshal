...
**230 entries open.** 63 closed and recorded in the ledger since it began on 2026-09-20.

| Status | Count | Meaning |
|---|---|---|
| IN PROGRESS | **0** | being worked in the current session |
| OPEN — actionable | **95** | no decision, no live box needed; can be closed by an agent |
| OPEN — needs operator | **68** | a decision, credential, account or purchase only the operator can make |
| OPEN — needs live proof | **57** | needs the running box, a deploy, hardware, or a human at a browser |
...
| Date | Entry | PR |
|---|---|---|
| 2026-09-24 | The durable escalation store only ever sees swarm-run escalations (2026-09-15) | #main |
| 2026-09-24 | Ambient Recall — relevance floor on "possibly related" hits | #main |
| 2026-09-24 | The calendar package imports a core feature the image never compiles (2026-09-18) | #main |
| 2026-09-24 | little-monsters looks for its education migration at a core path (2026-09-21) | #main |
