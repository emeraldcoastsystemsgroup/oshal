...
**242 entries open.** 51 closed and recorded in the ledger since it began on 2026-09-20.
...
| OPEN — needs live proof | **60** | needs the running box, a deploy, hardware, or a human at a browser |
...
| Date | Entry | PR |
|---|---|---|
| 2026-09-24 | Warn before an unrenewable connection lapses | #main |
| 2026-09-24 | A protected Jarvis answer with no bindable lineage leaves the thread silent | #main |
| 2026-09-24 | `src/app/server.ts` is past the decomposition threshold: move the post-bootstrap installs out (2026-09-17) | #main |
| 2026-09-24 | A failover the record configured must not have its completed work discarded (2026-09-17) | #main |
| 2026-09-24 | k8s runtime-launched bots do not read the chart's `oshal-shared-secret` (chart 0.5.0) | #main |
| 2026-09-24 | The bot's ownership helper answers about an app the caller merely named | #main |
| 2026-09-24 | The SEC/CORE/APP hardening-track identifiers have no definition anywhere in the repo | #main |
| 2026-09-24 | The ci-local export step after the purge is still unbounded | #main |
| 2026-09-24 | The spec-database gate cannot see the live database reached through `docker exec` | #main |
| 2026-09-24 | Surface-bridge ops have no success-path log line | #466 |
| 2026-09-24 | POST /api/swarm/apps/load and /import carry only the mount-level requiresAuth | #818 |
