...
**202 entries open.** 91 closed and recorded in the ledger since it began on 2026-09-20.

| Status | Count | Meaning |
|---|---|---|
| IN PROGRESS | **0** | being worked in the current session |
| OPEN — actionable | **84** | no decision, no live box needed; can be closed by an agent |
| OPEN — needs operator | **61** | a decision, credential, account or purchase only the operator can make |
| OPEN — needs live proof | **47** | needs the running box, a deploy, hardware, or a human at a browser |
...
| Date | Entry | PR |
|---|---|---|
| 2026-09-24 | DB-backed alert specs borrow the operator's database | #480 |
| 2026-09-24 | k8s runtime-launched bots set no securityContext, liveness or startup probe, or resources (chart 0.5.0) | #main |
| 2026-09-24 | Nothing publishes the container image, so the default install ships whatever was last pushed by hand | #main |
| 2026-09-24 | Workspace isolation: ACCEPTED as a shared read-write mount, and what reopens it (operator, 2026-09-20) | #main |
| 2026-09-24 | Node enrolment is the blocker for every remote-node capability | #567 |
| 2026-09-24 | A bot's LLM provider is a row in a table, not a literal in the registry (operator, 2026-09-17) | #main |
| 2026-09-24 | Deploy modes — `codebase` vs `codeless` development posture (ADR-137 amendment A) | #main |
| 2026-09-24 | World Intelligence: the market-hours pulse saturates the series store (2026-09-14) | #main |
