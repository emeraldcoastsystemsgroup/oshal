...
**194 entries open.** 99 closed and recorded in the ledger since it began on 2026-09-20.

| Status | Count | Meaning |
|---|---|---|
| IN PROGRESS | **0** | being worked in the current session |
| OPEN — actionable | **83** | no decision, no live box needed; can be closed by an agent |
...
| Date | Entry | PR |
|---|---|---|
| 2026-09-24 | Dependency tiers: four gaps the design surfaced (2026-09-14) | #main |
| 2026-09-24 | Headscale as standard practice, so an off-LAN node can actually join | #main |
| 2026-09-24 | App status contract (ADR-145) — build the `status:` declaration and the highlights section | #main |
| 2026-09-24 | Test Lab browser runner: the real-boundary proof has not run (2026-09-14) | #main |
