...
**234 entries open.** 59 closed and recorded in the ledger since it began on 2026-09-20.

| Status | Count | Meaning |
|---|---|---|
| IN PROGRESS | **0** | being worked in the current session |
| OPEN — actionable | **96** | no decision, no live box needed; can be closed by an agent |
...
| Date | Entry | PR |
|---|---|---|
| 2026-09-24 | Presentron chat and frontend contract | #main |
| 2026-09-24 | Store dependency tiers: manifests converted; catalog mirror and live proof open (2026-09-14) | #main |
