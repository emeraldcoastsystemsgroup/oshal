...
**214 entries open.** 79 closed and recorded in the ledger since it began on 2026-09-20.

| Status | Count | Meaning |
|---|---|---|
| IN PROGRESS | **0** | being worked in the current session |
| OPEN — actionable | **89** | no decision, no live box needed; can be closed by an agent |
| OPEN — needs operator | **66** | a decision, credential, account or purchase only the operator can make |
| OPEN — needs live proof | **49** | needs the running box, a deploy, hardware, or a human at a browser |
