...
**274 entries open.** 20 closed and recorded in the ledger since it began on 2026-09-20.

| Status | Count | Meaning |
|---|---|---|
| IN PROGRESS | **0** | being worked in the current session |
| OPEN — actionable | **104** | no decision, no live box needed; can be closed by an agent |
