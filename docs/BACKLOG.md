...
- **Narrowed 2026-09-21, not closed.** A row the venue has not confirmed no longer counts as cover:
  ...
  cover, and a resting sell older than the newest 100 rows is still invisible.
