...
**236 entries open.** 57 closed and recorded in the ledger since it began on 2026-09-20.

| Status | Count | Meaning |
|---|---|---|
| IN PROGRESS | **0** | being worked in the current session |
| OPEN — actionable | **98** | no decision, no live box needed; can be closed by an agent |
...
| Date | Entry | PR |
|---|---|---|
| 2026-09-24 | Payroll package backlog handoff | #main |
| 2026-09-24 | Fantasy — the app cannot tell "not connected" from "ESPN unreachable" | #main |
