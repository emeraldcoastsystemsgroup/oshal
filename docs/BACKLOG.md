...
**158 entries open.** 135 closed and recorded in the ledger since it began on 2026-09-20.

| Status | Count | Meaning |
|---|---|---|
| IN PROGRESS | **0** | being worked in the current session |
| OPEN — actionable | **47** | no decision, no live box needed; can be closed by an agent |
...
| 2026-09-24 | Video Series intro and season assembly | #main |
| 2026-09-24 | ADR-087 access-role deferred layers | #main |
| 2026-09-24 | Agentic workflow authoring and streamed canvas events | #main |
| 2026-09-24 | Workflow Studio draft execution and branching | #main |
