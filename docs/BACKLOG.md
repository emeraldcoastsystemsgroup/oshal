...
**162 entries open.** 131 closed and recorded in the ledger since it began on 2026-09-20.

| Status | Count | Meaning |
|---|---|---|
| IN PROGRESS | **0** | being worked in the current session |
| OPEN — actionable | **51** | no decision, no live box needed; can be closed by an agent |
...
| 2026-09-24 | Remote-client full-suite flake | #main |
| 2026-09-24 | OSHAL engineering-screen normalization | #main |
| 2026-09-24 | Embedded LLM tools as a formal tier | #main |
| 2026-09-24 | Queue-dispatched concierge answers carry the app's data context | #main |
