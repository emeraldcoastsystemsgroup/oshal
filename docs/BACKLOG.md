...
- **Remaining:** reconcile the requested live app summaries and durable advisory dismissal with the current Home implementation, then verify the signed-in landing and unavailable-source behavior.
