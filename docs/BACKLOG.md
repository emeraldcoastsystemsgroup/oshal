...
**210 entries open.** 83 closed and recorded in the ledger since it began on 2026-09-20.

| Status | Count | Meaning |
|---|---|---|
| IN PROGRESS | **0** | being worked in the current session |
| OPEN — actionable | **87** | no decision, no live box needed; can be closed by an agent |
| OPEN — needs operator | **65** | a decision, credential, account or purchase only the operator can make |
| OPEN — needs live proof | **48** | needs the running box, a deploy, hardware, or a human at a browser |
...
| Date | Entry | PR |
|---|---|---|
| 2026-09-24 | Free ComfyUI storyboard provider | #main |
| 2026-09-24 | Trading — the engine manages positions it did not buy (ADR-159, 2026-09-15) | #main |
| 2026-09-24 | The nightly trade recap has failed at the render-node lease since 2026-08-06 | #main |
| 2026-09-24 | Spaces: the PLY→splat converter runs on the api's event loop and a large import can take the box down (2026-09-14) | #main |
| 2026-09-24 | Chat-to-surface bridge | #main |
| 2026-09-24 | ADR-139 — adopt artifact source tags | #main |
| 2026-09-24 | Top-level workspaces for complete applications | #main |
| 2026-09-24 | Manifest bots get an ADR-034 authoritative record at load | #main |
