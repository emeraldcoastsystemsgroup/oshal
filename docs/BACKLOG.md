...
**272 entries open.** 22 closed and recorded in the ledger since it began on 2026-09-20.
...
| OPEN — needs operator | **67** | a decision, credential, account or purchase only the operator can make |
...
| Date | Entry | PR |
|---|---|---|
| 2026-09-24 | Daily Trade Recap's Home tiles count a table the production path never writes | #248 (store) |
| 2026-09-24 | Arming a second autopilot leg is a deliberate, gated act | #244 (store), 746, 802 |
| 2026-09-24 | Rides map and fare follow-ups | #243 (store), 801 |
| 2026-09-24 | Two manifests pin a bot id that belongs to another app (2026-09-14, corrected 2026-09-21) | #249 (store), 798, 799 |
