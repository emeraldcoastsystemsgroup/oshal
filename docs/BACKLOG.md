...
**218 entries open.** 75 closed and recorded in the ledger since it began on 2026-09-20.

| Status | Count | Meaning |
|---|---|---|
| IN PROGRESS | **0** | being worked in the current session |
| OPEN — actionable | **91** | no decision, no live box needed; can be closed by an agent |
| OPEN — needs operator | **66** | a decision, credential, account or purchase only the operator can make |
| OPEN — needs live proof | **51** | needs the running box, a deploy, hardware, or a human at a browser |
...
| Date | Entry | PR |
|---|---|---|
| 2026-09-24 | A calendar-preparation agent: brief me before the meeting (2026-09-14) | #main |
| 2026-09-24 | Trading — market movers: add Alpaca's REST screener as the whole-market source (ADR-143 D5) | #main |
| 2026-09-24 | Trading — timed orders: the STORE half of the D4 follow-ups (ADR-136 D4) | #main |
| 2026-09-24 | Trading watchdog hardening — the rest of the checks (ADR-134 D3.7) | #main |
| 2026-09-24 | Cockpit rail: static tiles that target another package must follow that package's discoverability (ADR-149) | #main |
| 2026-09-24 | Sat-ops forced-conjugate referee evidence | #main |
| 2026-09-24 | Drone relay chains (store package `drone-relay`, ADR-155) | #main |
| 2026-09-24 | Circuit Lab (store package `circuit-lab`, ADR-154) | #main |
| 2026-09-24 | Person-model maintenance never runs on a box that restarts daily | #main |
| 2026-09-24 | The nightly trading assessment loses its per-algo record to a market-data rate limit (2026-09-15) | #main |
| 2026-09-24 | Trading DB specs race on schema bootstrap | #main |
| 2026-09-24 | A bot that cannot reach Postgres in its first 20 seconds is pool-less for life, and says it is healthy (2026-09-17) | #main |
