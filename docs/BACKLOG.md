...
**178 entries open.** 115 closed and recorded in the ledger since it began on 2026-09-20.

| Status | Count | Meaning |
|---|---|---|
| IN PROGRESS | **0** | being worked in the current session |
| OPEN — actionable | **67** | no decision, no live box needed; can be closed by an agent |
...
| Date | Entry | PR |
|---|---|---|
| 2026-09-24 | Queue dashboards per-app isolation | #main |
| 2026-09-24 | Apps page as a swarm catalog | #main |
| 2026-09-24 | Jarvis hand-off experience | #main |
| 2026-09-24 | Jarvis and a compact daily dashboard | #main |
