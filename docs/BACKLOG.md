...
**206 entries open.** 87 closed and recorded in the ledger since it began on 2026-09-20.

| Status | Count | Meaning |
|---|---|---|
| IN PROGRESS | **0** | being worked in the current session |
| OPEN — actionable | **85** | no decision, no live box needed; can be closed by an agent |
