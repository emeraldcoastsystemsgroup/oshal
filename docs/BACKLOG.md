...
**266 entries open.** 28 closed and recorded in the ledger since it began on 2026-09-20.
...
| OPEN — needs operator | **66** | a decision, credential, account or purchase only the operator can make |
...
| OPEN — untriaged | **46** | filed after the 2026-09-15 triage; has no verdict yet |
