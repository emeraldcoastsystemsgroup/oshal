...
**190 entries open.** 103 closed and recorded in the ledger since it began on 2026-09-20.

| Status | Count | Meaning |
|---|---|---|
| IN PROGRESS | **0** | being worked in the current session |
| OPEN — actionable | **79** | no decision, no live box needed; can be closed by an agent |
...
| Date | Entry | PR |
|---|---|---|
| 2026-09-24 | Every deterministic service-route schedule on this box is refused under ADR-149 enforce (2026-09-14) | #main |
| 2026-09-24 | BYO/free-tier tool-capable turns | #main |
| 2026-09-24 | A BYO connection makes Jarvis tool-less, which is why it defers instead of answering | #main |
| 2026-09-24 | Application test cases register with AI Test Lab during installation | #main |
