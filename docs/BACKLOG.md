...
**186 entries open.** 107 closed and recorded in the ledger since it began on 2026-09-20.

| Status | Count | Meaning |
|---|---|---|
| IN PROGRESS | **0** | being worked in the current session |
| OPEN — actionable | **75** | no decision, no live box needed; can be closed by an agent |
...
| Date | Entry | PR |
|---|---|---|
| 2026-09-24 | Twilio policy, fallback, and inbound messaging | #main |
| 2026-09-24 | Jarvis knows the shape of the data he can reach | #main |
| 2026-09-24 | The DB-backed unit specs need a disposable PostgreSQL to run against | #main |
| 2026-09-24 | Configure by package: the plan resolves, the apply is still one change at a time (2026-09-17) | #main |
