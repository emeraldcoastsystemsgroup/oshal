...
**271 entries open.** 23 closed and recorded in the ledger since it began on 2026-09-20.

| Status | Count | Meaning |
|---|---|---|
| IN PROGRESS | **0** | being worked in the current session |
| OPEN — actionable | **101** | no decision, no live box needed; can be closed by an agent |
...
| Date | Entry | PR |
|---|---|---|
| 2026-09-24 | Deploy verification cannot clean its Jarvis task while oshal-engineering is inactive | #804 |
