...
**182 entries open.** 111 closed and recorded in the ledger since it began on 2026-09-20.

| Status | Count | Meaning |
|---|---|---|
| IN PROGRESS | **0** | being worked in the current session |
| OPEN — actionable | **71** | no decision, no live box needed; can be closed by an agent |
...
| Date | Entry | PR |
|---|---|---|
| 2026-09-24 | Chat-channel adapter core | #main |
| 2026-09-24 | Per-app workspace consolidation | #main |
| 2026-09-24 | Surface theming — visual spot check across themes | #main |
| 2026-09-24 | Complete and cancel nightly backup checks safely | #main |
