...
**198 entries open.** 95 closed and recorded in the ledger since it began on 2026-09-20.
...
| Date | Entry | PR |
|---|---|---|
| 2026-09-24 | Marketing suite — core dependencies (package work is in the store) | #431 |
| 2026-09-24 | The Cline fallback brain could not start: a glibc executable on a musl base (2026-09-17) | #main |
| 2026-09-24 | Codex swarm-side OAuth — the token exchange fails at the last step (2026-09-08) | #main |
| 2026-09-24 | Gemini reaches the swarm as a FREE-TIER API key, and there is no rail to seed the operator's own login (2026-09-22) | #main |
