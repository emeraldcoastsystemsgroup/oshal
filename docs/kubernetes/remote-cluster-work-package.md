...
| [`docs/k8/README.md`](../k8/README.md) | **Accurate.** Every path it cites resolves, and it correctly demotes the legacy path. This is the doc to read first. |
...
`docs/setup/core-setup.md:95-100` at [`docs/k8/README.md`](../k8/README.md) and ADR-129. Fix
...
- [docs/k8/README.md](../k8/README.md) — the accurate operating index for the current path.
