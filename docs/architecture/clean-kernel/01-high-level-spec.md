...
| Packages compiled against the kernel's path aliases and loaded in-process | 516 package files import 125 kernel internals at 1,413 sites, including route modules used as libraries — generated by `scripts/kernel-import-inventory.js`, never hand-typed | versioned SDK + sandboxed host (§4.5); capabilities are the imports granted |
...
| Distinct kernel modules imported by packages / import sites | 125 / 1,413 (`scripts/kernel-import-inventory.js`) |
