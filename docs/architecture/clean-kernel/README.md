...
> **The defect claims in documents 10 and 11 have been verified against the tree and partly corrected.**
> [`docs/backlog/clean-kernel-repair.md`](../../backlog/clean-kernel-repair.md) is the queue that came out
> of it and the authority on what is real. Do not size work from document 11's tables.
...
| # | Document | Status |
|---|---|---|
| 10 | [What we are actually improving](./10-what-we-are-improving.md) — **read this first**: the fifteen defects in today’s codebase with measured evidence, the one law behind them, what each design change fixes, and the project scoreboard | DRAFT 2026-09-18 |
