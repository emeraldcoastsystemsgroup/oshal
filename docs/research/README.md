...
- [Autonomous Explorer — Design Study](./autonomous-explorer-design-study.md) — simulation-only study of machines that move on ambient energy (tidal/wave flow, soil thermal gradient). Working physics models, a parametric geometry and CAD export layer, and a fully modelled 300 mm ocean explorer. Main result: endurance is bounded by fouling and mechanical wear, not by the energy budget. Companion report with drawings, a 432-design sweep and a BOM: [ambient-energy-vessel-report.pdf](./ambient-energy-vessel-report.pdf). **No hardware was built and no land mover was found** — read "What is not true" before citing any figure
