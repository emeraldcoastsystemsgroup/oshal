 ...
 * 5 | maintainer@emeraldcoastsystemsgroup.com   | Moved the modal stylesheet into chat-rag-workspace-styles.mjs; the inline CSS template literal counted as 335 code lines and pushed this controller over the 1000-code-line cap
 */

import { escapeHtml, requestJson, toMessage } from '/chat-assets/chat-workspace-popups-utils.mjs';
import { RAG_WORKSPACE_MODAL_CSS } from '/chat-assets/chat-rag-workspace-styles.mjs';
