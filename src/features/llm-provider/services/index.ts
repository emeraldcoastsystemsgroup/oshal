 ...
 * 11 | maintainer@emeraldcoastsystemsgroup.com   | Barrel-export antigravity-cli-availability: whether THIS node could run `agy` at all (binary present, and the libc able to load it), asked without spawning. Pure fs/path, so it does not reintroduce the harness stack SEQ 9 removed.
 */
...
} from './antigravity-cli-availability';
export {
