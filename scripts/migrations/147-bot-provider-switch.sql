 ...
 * 3 | maintainer@emeraldcoastsystemsgroup.com   | Renumbered 146 -> 147 before merge: PR #605 (authz-oidc-app-tier) owns 146-app-access-legacy-issuerless-rows.sql and lands first; main's highest is 144 and #605 adds 145 and 146. The table, policies and CHECKs are unchanged; migrations apply in filename order, so this file follows #605's.
 */

-- =============================================================================
-- Migration 147: the LLM provider switch rows
