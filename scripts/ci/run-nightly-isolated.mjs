 ...
 * 4 | maintainer@emeraldcoastsystemsgroup.com | The BUG-21 tail guard joins the fixed isolated set: the unattended monitoring-liveness watch must keep failing loudly against an unreachable overlay and keep refusing to start anything.
 */
...
export const NIGHTLY_ISOLATED_SUITES = Object.freeze([
  ...
  'tests/unit/monitoring-liveness-watch.spec.ts',
]);
