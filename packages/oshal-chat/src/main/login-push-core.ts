...
/**
 * @description Narrows an account id to the logins that can be pushed.
 * @param id - Account id from the local account list (codex / claude / gemini / gcloud / aws)
 * @returns true for codex, claude and gemini
 */
